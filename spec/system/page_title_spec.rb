...
RSpec.describe 'Page' do
  ...
  context 'when user is authenticated' do
    ...
    context 'and viewing module content' do
      [
        ['what-to-expect',    'Content overview : What to expect during the training'],
        ['1-1',               'Content overview : The first submodule'],
        ...
        ['1-2',               'Content overview : The second submodule'],
        ...
        ['1-3',               'Content overview : Summary and next steps'],
        ['1-3-1',             'Content overview : Recap'],
        ['1-3-2',             'Content overview : End of module test'],
        ...
        ['1-3-2-11',           'Content overview : Assessment results'],
        ['1-3-3',             'Content overview : Reflect on your learning'],
        # ['1-3-3-1',           'First Training Module : 1-3-3-1'],
        # ['1-3-3-2',           'First Training Module : 1-3-3-2'],
        # ['1-3-3-3',           'First Training Module : 1-3-3-3'],
        ['1-3-3-5',           'Content overview : Thank you'],
        ['1-3-4',             'Content overview : Download your certificate'],
      ].each do |page, title|
