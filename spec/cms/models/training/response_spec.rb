  ...
  context 'with radio button' do
    describe 'with no answer' do
      ...
      it 'is invalid' do
        ...
        expect(radio_button_response.errors.full_messages).to eq ["Answer can't be blank"]
      end
    end
  ...
  context 'with check box' do
    describe 'with no answer' do
      ...
      it 'is invalid' do
        ...
        expect(check_box_response.errors.full_messages).to eq ["Answer can't be blank"]
      end
    end
