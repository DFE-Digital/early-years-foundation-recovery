...
RSpec.describe 'Page content (locales/modules)' do
  ...
  describe 'formative' do
    ...
    specify { expect(FormativeQuestionnaire.count).to be 65 }
  end
  ...
  describe 'summative' do
    ...
    specify { expect(SummativeQuestionnaire.count).to be 34 }
  end
  ...
  describe 'confidence' do
    ...
    specify { expect(ConfidenceQuestionnaire.count).to be 19 }
  end
end
