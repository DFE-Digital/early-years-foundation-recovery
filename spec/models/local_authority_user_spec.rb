...
RSpec.describe LocalAuthorityUser do
  subject(:local_authority_user) do
    described_class.new
  end
  ...
  describe '.to_csv' do
    context 'when no users exist' do
      it 'creates csv data with columns but no rows' do
        expect(local_authority_user.to_csv).to eq("Local Authority,Total Users,Registration Completed\n")
      end
    end
