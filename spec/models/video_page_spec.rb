  ...
  describe '#video_url' do
    context 'when vimeo' do
      it 'sources from vimeo' do
        expect(video_page.video_url).to include 'https://player.vimeo.com/video/743243040?enablejsapi=1&amp;origin='
      end
    end
    ...
    context 'when youtube' do
      ...
      it 'sources from youtube' do
        expect(video_page.video_url).to include 'https://www.youtube.com/embed/XnP6jaK7ZAY?enablejsapi=1&amp;origin='
      end
    end
  end
end
