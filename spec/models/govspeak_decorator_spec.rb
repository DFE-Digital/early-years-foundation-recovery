...
RSpec.describe GovspeakDecorator do
  ...
  it 'embeds YouTube  as iframe' do
    ...
    expected_html = %(<div class="govspeak-embed-container"><iframe class="govspeak-embed-video" src="https://www.youtube.com/embed/ABCDEFGHIJ?enablejsapi=1&amp;origin=#{ENV['DOMAIN']}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe></div>\n)
  ...
  it 'Youtube Embedding with title' do
    ...
    expected_html = %(<div class="govspeak-embed-container"><iframe class="govspeak-embed-video" src="https://www.youtube.com/embed/EpjSlCJtPLo?enablejsapi=1&amp;origin=#{ENV['DOMAIN']}" title="Test title" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe></div>\n)
    rendered = described_class.translate_markdown(govspeak_md)
    expect(rendered).to eq(expected_html)
  end
  ...
  it 'Youtube Embedding without title' do
    ...
    expected_html = %(<div class="govspeak-embed-container"><iframe class="govspeak-embed-video" src="https://www.youtube.com/embed/EpjSlCJtPLo?enablejsapi=1&amp;origin=#{ENV['DOMAIN']}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe></div>\n)
    rendered = described_class.translate_markdown(govspeak_md)
    expect(rendered).to eq(expected_html)
  end
