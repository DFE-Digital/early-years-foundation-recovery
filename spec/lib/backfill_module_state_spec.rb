...
RSpec.describe BackfillModuleState do
  ...
  before do
    ...
    create_event(user1, 'module_content_page', Time.zone.local(2000, 0o1, 0o3), 'child-development-and-the-eyfs', '1-3-2-6')
    create_event(user1, 'module_content_page', Time.zone.local(2000, 0o1, 0o2), 'brain-development-and-how-children-learn', 'intro')
    create_event(user1, 'module_content_page', Time.zone.local(2000, 0o1, 0o3), 'brain-development-and-how-children-learn', '2-3-3-5')
    ...
    create_event(user2, 'module_content_page', Time.zone.local(2000, 0o1, 0o3), 'child-development-and-the-eyfs', '1-3-2-6')
