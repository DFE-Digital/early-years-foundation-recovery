class NotifyMailer < GovukNotifyRails::Mailer
  ...
  def activation_instructions(record, token, _opts = {})
    ...
    Rails.logger.info("token included in activation mail?: #{token.present?}")
  ...
  def email_confirmation_instructions(record, token, _opts = {})
    ...
    Rails.logger.info("token included in email confirmation mail?: #{token.present?}")
  ...
  def reset_password_instructions(record, token, _opts = {})
    ...
    Rails.logger.info("token included in password reset mail?: #{token.present?}")
