...
#
# GOV.UK Rebrand - Updated Header Component
# Uses standard GOV.UK Header with DfE logo
# @see https://design.education.gov.uk/design-system/dfe-header-rebrand
#
...
private
  ...
  private
    ...
    def default_attributes
      { class: %w[govuk-service-navigation__item] }
    end
  end
end
