  ...
  class UserLastInteraction
    ...
    class << self
      ...
      def dashboard
        ...
        latest_module_progress = UserModuleProgress.where(updated_at: cutoff..)
                                                   .where.not(user_id: nil)
                                                   .group(:user_id)
                                                   .maximum(:updated_at)

        user_ids = (latest_responses.keys + latest_assessments.keys + latest_notes.keys + latest_module_progress.keys).uniq
        ...
        user_ids.map { |user_id|
          ...
          times = [
            ...
            latest_module_progress[user_id],
          ].compact
