...
ActiveRecord::Schema[7.2].define(version: 2025_12_23_155510) do
  ...
  create_table "user_module_progresses", force: :cascade do |t|
    t.bigint "user_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "module_name"], name: "index_user_module_progresses_on_user_id_and_module_name", unique: true
