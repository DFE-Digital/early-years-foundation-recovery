...
CREATE TABLE public.user_answers (
    ...
    name character varying,
    assessments_type character varying,
    user_assessment_id bigint
);
...
CREATE TABLE public.users (
    ...
    private_beta_registration_complete boolean DEFAULT false,
    ...
    role_type_other character varying,
    setting_type_id character varying,
    registration_complete boolean DEFAULT false,
    closed_at timestamp without time zone,
    closed_reason character varying,
    closed_reason_custom character varying
);
...
--
-- Name: index_user_answers_on_questionnaire_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_user_answers_on_questionnaire_id ON public.user_answers USING btree (questionnaire_id);


--
-- Name: index_user_answers_on_questionnaire_id_and_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_user_answers_on_questionnaire_id_and_user_id ON public.user_answers USING btree (questionnaire_id, user_id);


--
-- Name: index_user_answers_on_user_assessment_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_user_answers_on_user_assessment_id ON public.user_answers USING btree (user_assessment_id);
...
--
-- Name: index_user_assessments_on_score_and_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_user_assessments_on_score_and_status ON public.user_assessments USING btree (score, status);


--
-- Name: index_user_assessments_on_user_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_user_assessments_on_user_id ON public.user_assessments USING btree (user_id);
...
--
-- Name: user_answers fk_rails_a9e2e3e202; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_answers
    ADD CONSTRAINT fk_rails_a9e2e3e202 FOREIGN KEY (user_assessment_id) REFERENCES public.user_assessments(id);


--
-- Name: user_assessments fk_rails_b4a24cf7e1; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.user_assessments
    ADD CONSTRAINT fk_rails_b4a24cf7e1 FOREIGN KEY (user_id) REFERENCES public.users(id);
