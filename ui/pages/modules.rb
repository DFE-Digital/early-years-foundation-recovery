...
module Pages
  class Modules < Base
    ...
    element :start_button_module_four, "a[href='/modules/module-4/content-pages/what-to-expect']"
    ...
    element :two_to_three_years_radio_button, '.govuk-radios__label', text: '2 to 3 years'
    element :verbs_radio_button, '.govuk-radios__label', text: 'verbs'
    element :plan_an_activity_on_pronunciation_radio_button, '.govuk-radios__label', text: 'Plan an activity on pronunciation'
    element :skinner_radio_button, '.govuk-radios__label', text: 'Skinner'
    element :pecs_radio_button, '.govuk-radios__label', text: 'PECS'
    element :discrimination_radio_button, '.govuk-radios__label', text: 'Discrimination'
    element :special_educational_needs_radio_button, '.govuk-radios__label', text: 'Special educational needs'

    element :limited_knowledge_of_childrens_needs_radio_button, '.govuk-radios__label', text: 'Limited knowledge of children’s needs'
    element :build_a_positive_relationship_radio_button, '.govuk-radios__label', text: 'Build a positive relationship'
    element :expanding_what_a_child_has_said_radio_button, '.govuk-radios__label', text: 'Expanding what a child has said'

    element :teaching_children_to_take_turns_when_talking_check_box, '.govuk-checkboxes__label', text: 'Teaching children to take turns when talking'
    element :helping_children_to_discuss_personal_information_check_box, '.govuk-checkboxes__label', text: 'Helping children to discuss personal information'

    element :increased_exploration_radio_button, '.govuk-radios__label', text: 'Increased exploration'
    element :a_language_rich_approach_radio_button, '.govuk-radios__label', text: 'A language rich approach'

    element :busier_lifestyles_check_box, '.govuk-checkboxes__label', text: 'Busier lifestyles'
    element :increased_access_to_technology_check_box, '.govuk-checkboxes__label', text: 'Increased access to technology'
    element :imposed_lockdowns_check_box, '.govuk-checkboxes__label', text: 'Imposed lockdowns'

    element :six_to_eight_months_radio_button, '.govuk-radios__label', text: '6 to 8 months'
    element :telegraphic_stage_radio_button, '.govuk-radios__label', text: 'Telegraphic stage'
    element :imitation_check_box, '.govuk-checkboxes__label', text: 'Imitation'
    element :reinforcement_check_box, '.govuk-checkboxes__label', text: 'Reinforcement'
    element :conditioning_check_box, '.govuk-checkboxes__label', text: 'Conditioning'
    element :parents_or_carers_education_radio_button, '.govuk-radios__label', text: 'Parents\' or carers\' education'
    element :early_intervention_radio_button, '.govuk-radios__label', text: 'Early intervention'
    element :frustration_radio_button, '.govuk-radios__label', text: 'Frustration'
    element :time_consuming_radio_button, '.govuk-radios__label', text: 'Time consuming'
    element :modelling_language_radio_button, '.govuk-radios__label', text: 'Modelling language'
    element :interactions_with_others_radio_button, '.govuk-radios__label', text: 'Interactions with others'
    element :confidence_radio_button, '.govuk-radios__label', text: 'Confidence'
    ...
    def complete_module_four
      sleep(5)
      start_button_module_four.click
      sleep(10)
      next_button.click
      sleep(2)
      next_button.click
      ...
      next_button.click
      sleep(2)
      two_to_three_years_radio_button.click
      sleep(2)
      next_button_1.click
      sleep(2)
      next_button.click
      ...
      save_and_continue_button.click
      sleep(2)
      plan_an_activity_on_pronunciation_radio_button.click
      sleep(2)
      next_button_1.click
      sleep(2)
      next_button.click
      ...
      discrimination_radio_button.click
      sleep(2)
      next_button_1.click
      sleep(2)
      next_button.click
      ...
      special_educational_needs_radio_button.click
      sleep(2)
      next_button_1.click
      sleep(2)
      next_button.click
      ...
      limited_knowledge_of_childrens_needs_radio_button.click
      sleep(2)
      next_button_1.click
      sleep(2)
      next_button.click
      ...
      build_a_positive_relationship_radio_button.click
      sleep(2)
      next_button_1.click
      sleep(2)
      next_button.click
      ...
      expanding_what_a_child_has_said_radio_button.click
      sleep(2)
      next_button_1.click
      sleep(2)
      next_button.click
      ...
      teaching_children_to_take_turns_when_talking_check_box.click
      helping_children_to_discuss_personal_information_check_box.click
      ...
      increased_exploration_radio_button.click
      sleep(2)
      next_button_1.click
      sleep(2)
      next_button.click
      ...
      a_language_rich_approach_radio_button.click
      sleep(2)
      next_button_1.click
      sleep(2)
      next_button.click
    ...
    def complete_module_four_test
      sleep(2)
      start_test_button.click
      sleep(2)
      six_to_eight_months_radio_button.click
      sleep(2)
      save_and_continue_button.click
      sleep(2)
      telegraphic_stage_radio_button.click
      sleep(2)
      save_and_continue_button.click
      sleep(2)
      imitation_check_box.click
      reinforcement_check_box.click
      conditioning_check_box.click
      sleep(2)
      save_and_continue_button.click
      sleep(2)

      parents_or_carers_education_radio_button.click
      sleep(2)
      save_and_continue_button.click
      sleep(2)

      early_intervention_radio_button.click
      sleep(2)
      save_and_continue_button.click
      sleep(2)

      frustration_radio_button.click
      sleep(2)
      save_and_continue_button.click
      sleep(2)

      time_consuming_radio_button.click
      sleep(2)
      save_and_continue_button.click
      sleep(2)

      modelling_language_radio_button.click
      sleep(2)
      save_and_continue_button.click
      sleep(2)

      interactions_with_others_radio_button.click
      sleep(2)
      save_and_continue_button.click
      sleep(2)

      confidence_radio_button.click
      sleep(2)
